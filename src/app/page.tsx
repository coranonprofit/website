          ...
          <main>
              ...
              <Container>
                  ...
                  <div className={styles.text}>
                      ...
                      <h2>Student Lead</h2>
                      <p>
                          100% of all events, projects, meetings, and ideas are
                          initiated and run by our amazing student leaders!
                      </p>
                  </div>
              </Container>
              ...
              <Container>
                  <div className={styles.text}>
                      ...
                      <p>
                          ...
                          our communities! All donations are tax deductible (up
                          to 60% of the donation) in the United States.
                      </p>
                  </div>
              ...
              <Container style={{ height: "min-content" }}>
                  <div className={styles.mixed}>
                      ...
                      <small>
                          Note: numbers reported only account for part 1 of the
                          food drive, and did not count amount donated to CHUM.
                      </small>
                  </div>
